...
import {configurationOf, configWallHeight, cornerTolerance} from '../core/configuration.js';
 ...
 *
 * @typedef {import('./floorplan.js').Floorplan} Floorplan
	...
	constructor(floorplan, x, y, id)
	{
		...
		**/
		...
		/**
			...
			* @type {Number}
		**/
		// Through the floorplan since P7, so two designs can carry different wall
		// heights. `configurationOf` falls back to the shared default, which keeps
		// a Corner built without a floorplan behaving exactly as it did.
		this._elevation = configurationOf(this.floorplan).getNumericValue(configWallHeight);
		/**
